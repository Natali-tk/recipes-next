  ...
  return (
    <Card className="w-full min-w-[254px] max-w-md h-[480px] flex flex-col">
      <div className="h-48 overflow-hidden">
        {recipe.imageUrl ? (
          <div className="relative h-48 w-full overflow-hidden rounded-t-lg group  border border-gray-200 bg-white shadow-md transition-all hover:shadow-lg">
            <Image
              src={recipe.imageUrl}
      ...
      <CardBody className="flex-1 text-black">
        <p className="text-gray-600">{recipe.description || "Без опису"}</p>
        <h3 className="mt-4 font-semibold">Інградієнти:</h3>

...
export const useIngredientStore = create<IngredientState>((set) => ({
  ...
  loadIngredients: async () => {
    ...
    try {
      ...
      set({ error: "Помилка при завантаженні інградієнтів!", isLoading: false });
    }
  },
  addIngredient: async (formData: FormData) => {
    ...
    try {
      ...
      set({ error: "Помилка при додаванні інградієнта!", isLoading: false });
    }
  },
  removeIngredient: async (id: string) => {
    ...
    try {
      ...
      set({ error: "Помилка при видаленні інградієнта!", isLoading: false });
    }
  }
}))